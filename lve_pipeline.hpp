...
namespace lve
{
    ...
    {
        PipelineConfigInfo(const PipelineConfigInfo &) = delete;            // disable copy constructor
        PipelineConfigInfo &operator=(const PipelineConfigInfo &) = delete; // disalble copy operator
